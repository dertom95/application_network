...
SET solution=application_network.sln
SET version=15
SET log=build.log
...
IF EXIST "..\..\..\..\czmq\builds/msvc/vs2017\czmq.import.props" (
    COPY /Y "..\..\..\..\czmq\builds/msvc/vs2017\czmq.import.props" . > %log%
    IF errorlevel 1 GOTO error
) ELSE (
...
IF EXIST "..\..\..\..\zyre\builds/msvc/vs2017\zyre.import.props" (
    COPY /Y "..\..\..\..\zyre\builds/msvc/vs2017\zyre.import.props" . > %log%
    IF errorlevel 1 GOTO error
) ELSE (
    ECHO Did not find zyre, aborting.
    ECHO Please clone from https://github.com/zeromq/zyre.git, and then build.
    GOTO error
)
IF EXIST "..\..\..\..\cjson\builds/msvc/vs2017\cjson.import.props" (
    COPY /Y "..\..\..\..\cjson\builds/msvc/vs2017\cjson.import.props" . > %log%
    IF errorlevel 1 GOTO error
) ELSE (
    ECHO Did not find cjson, aborting.
    ECHO Please clone from https://github.com/davegamble/cjson, and then build.
    GOTO error
)

ECHO %action% application_network... (%packages%)
