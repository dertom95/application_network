...
application_network_cdefs.extend (czmq_cdefs)
################################################################################
#  THIS FILE IS 100% GENERATED BY ZPROJECT; DO NOT EDIT EXCEPT EXPERIMENTALLY  #
#  Read the zproject/README.md for information about making permanent changes. #
################################################################################
...
application_network_cdefs.extend (zyre_cdefs)
...
''')
for i, item in enumerate (application_network_cdefs):
    application_network_cdefs [i] = re.sub(r';[^;]*\bva_list\b[^;]*;', ';', item, flags=re.S) # we don't support anything with a va_list arg
