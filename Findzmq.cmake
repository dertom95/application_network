...
if (NOT MSVC)
    ...
    pkg_check_modules(PC_ZMQ "zmq")
    if (PC_ZMQ_FOUND)
        # add CFLAGS from pkg-config file, e.g. draft api.
        add_definitions(${PC_ZMQ_CFLAGS} ${PC_ZMQ_CFLAGS_OTHER})
        # some libraries install the headers is a subdirectory of the include dir
        # returned by pkg-config, so use a wildcard match to improve chances of finding
        # headers and SOs.
        set(PC_ZMQ_INCLUDE_HINTS ${PC_ZMQ_INCLUDE_DIRS} ${PC_ZMQ_INCLUDE_DIRS}/*)
        set(PC_ZMQ_LIBRARY_HINTS ${PC_ZMQ_LIBRARY_DIRS} ${PC_ZMQ_LIBRARY_DIRS}/*)
    endif(PC_ZMQ_FOUND)
endif (NOT MSVC)
...
find_path (
    ...
    NAMES zmq.h
    HINTS ${PC_ZMQ_INCLUDE_HINTS}
)

find_library (
    ${CMAKE_FIND_PACKAGE_NAME}_LIBRARIES
    NAMES zmq
    HINTS ${PC_ZMQ_LIBRARY_HINTS}
)
