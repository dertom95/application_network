...
if [ "$BUILD_TYPE" == "default" ]; then
    ...
    mkdir dist
    export APPLICATION_NETWORK_DEPLOYMENT=dist/*
    ...
    export APPLICATION_NETWORK_DEPLOYMENT=bindings/jni/application_network-jni/android/application_network-android-*.jar
else
    export APPLICATION_NETWORK_DEPLOYMENT=""
fi
